...
//    }
    ...
    public void start(Stage primaryStage) {
        ...
        String card1=new String("javaclass/image/card/" +String.valueOf(r1)+".png");
        String card2=new String("javaclass/image/card/" +String.valueOf(r2)+".png");
        String card3=new String("javaclass/image/card/" +String.valueOf(r3)+".png");
        String card4=new String("javaclass/image/card/" +String.valueOf(r4)+".png");
