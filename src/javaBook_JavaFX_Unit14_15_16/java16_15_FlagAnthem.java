...
public class java16_15_FlagAnthem extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        for (int i = 0; i < NUMBER_OF_NATIONS; i++) {
            images[i] = new Image(URLBase + "javaBook_JavaFX_Unit14_15_16/image/flag" + i + ".gif");
